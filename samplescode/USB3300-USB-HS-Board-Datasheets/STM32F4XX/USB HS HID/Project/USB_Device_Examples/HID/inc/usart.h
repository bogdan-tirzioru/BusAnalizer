...
#define Open207V_USART_RX_PIN                 GPIO_Pin_6
#define Open207V_USART_RX_GPIO_PORT           GPIOD
#define Open207V_USART_RX_GPIO_CLK            RCC_AHB1Periph_GPIOD
#define Open207V_USART_RX_SOURCE              GPIO_PinSource6
